"""
Geometric Herding Initializer — Convergence Curve
====================================================
Loads the steps-vs-MSE CSVs produced by experiment_matrix.py's convergence
sweep (--mode convergence, ACTIVE_INITIALIZER='geo'), computes the Area
...
(with ACTIVE_INITIALIZER = 'geo' in experiment_matrix.py)

    python -m ts_distill.distillation_core.initializer.convergence_speed.geo_curve
"""
